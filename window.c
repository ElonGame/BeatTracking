...
static SAMPLE besseli0 (SAMPLE x);
static SAMPLE factorial (int k);

void calc_kaiser_window (SAMPLE * data, int datalen, SAMPLE beta)
{
	/*
...
void calc_nuttall_window (SAMPLE * data, int datalen)
{
	const SAMPLE a [4] = { 0.355768, 0.487396, 0.144232, 0.012604 };
	int k;
...
void calc_hann_window (SAMPLE * data, int datalen)
{
	int k;
...
static SAMPLE factorial (int val)
{	static SAMPLE memory [64] = { 1.0 };
